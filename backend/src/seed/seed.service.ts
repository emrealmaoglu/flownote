          ...
          blocks: [
            {
              ...
              type: "text",
              order: 1,
              data: { text: "Welcome directly from the seed service!" },
            },
          ],
        },
      },
            ...
            blocks: [
              {
                ...
                type: "text",
                order: 1,
                data: { text: "CI/CD steps using GitHub Actions..." },
              },
            ],
          },
        },
            ...
            blocks: [
              {
                ...
                type: "text",
                order: 1,
                data: { text: "Interview results from 5 users..." },
              },
            ],
          },
        },
            ...
            blocks: [
              {
                ...
                type: "text",
                order: 1,
                data: { text: "Primary Color: #3b82f6\nSpacing: 4px base" },
              },
            ],
          },
        },
            ...
            blocks: [
              {
                ...
                type: "text",
                order: 1,
                data: { text: "Twitter threads for launch week..." },
              },
            ],
          },
        },
            ...
            blocks: [
              {
                ...
                type: "text",
                order: 1,
                data: { text: "Introducing FlowNote: The Future of Notes" },
              },
            ],
          },
        },
          ...
          blocks: [
            {
              ...
              type: "text",
              order: 1,
              data: { text: "Quick thought logged." },
            },
          ],
        },
      },
